...
function Herosection() {
    return (
        ...
        <section id='hero' className='relative min-h-screen flex flex-col items-center justify-center px-4 pt-28 md:pt-0'>
            ...
            <div className='container max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center z-10 w-full'>
                ...
                <div className='flex justify-center items-center order-1 md:order-2 opacity-0 animate-fade-in-delay-2 mt-4 md:mt-0'>
